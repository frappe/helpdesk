  ...
  >
    <div
      v-if="
        ...
        !assignmentRuleData.assignmentRuleName.trim()
      "
      ...
      <div>
        <div class="flex flex-col gap-1">
          ...
          <div class="flex items-center justify-between gap-6">
            ...
            <div v-if="isOldSla && assignmentRuleData.unassignCondition">
              <Popover trigger="hover" :hoverDelay="0.25" placement="top-end">
                <template #target>
                  <div
                    class="text-sm text-ink-gray-6 flex gap-1 cursor-default text-nowrap items-center"
    ...
    <div v-if="initialData" class="bg-white py-4 lg:py-8 sticky top-0">
...
const deskUrl = `${window.location.origin}/app/assignment-rule/${router.currentRoute.value.params.id}`;
