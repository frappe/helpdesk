		...
		<div>
			...
			<div v-if="expandWorkingHours">
				...
				<div class="py-4 space-y-3 text-gray-900">
					<div v-for="(workingHour, day) in workingHours" :key="day">
						<div class="flex text-base items-center h-7">
							<div class="w-2/12">{{ day }}</div>
...
export default {
	...
	setup(props) {
		...
		const slaPolicyName = ref('New Service Policy')
		...
		const workingHours = ref({
			...
			Tuesday: {enabled: true, from: '9:00 AM', to: '5:00 PM'},
			Wednesday: {enabled: true, from: '9:00 AM', to: '5:00 PM'},
			Thursday: {enabled: true, from: '9:00 AM', to: '5:00 PM'},
			Friday: {enabled: true, from: '9:00 AM', to: '5:00 PM'},
			Saturday: {enabled: false, from: '9:00 AM', to: '5:00 PM'},
			Suday: {enabled: false, from: '9:00 AM', to: '5:00 PM'},
		})
