    ...
    >
      ...
      >
        ...
        <div class="flex flex-col gap-3">
          ...
          <textarea
            ref="titleRef"
            class="w-full resize-none border-0 text-3xl font-bold placeholder-ink-gray-3 bg-surface-white p-0 pb-3 border-b border-outline-gray-1 focus:ring-0 focus:border-outline-gray-1 overflow-hidden"
            v-model="title"
