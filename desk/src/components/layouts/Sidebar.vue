<template>
  <div
    class="flex select-none flex-col border-r border-[#022c3f] bg-[#02374f] p-2 text-base text-ink-white duration-300 ease-in-out"
    :style="{
      'min-width': width,
      'max-width': width,
    }"
  >
    ...
    >
      <template #right>
        <span class="flex items-center gap-0.5 font-medium text-ink-gray-2">
