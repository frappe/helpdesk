...
const inputClasses = computed(() => {
  ...
  let variantClasses = {
    subtle:
      "border border-outline-gray-1 bg-surface-gray-4 placeholder-ink-gray-5 hover:border-outline-gray-1 hover:bg-surface-gray-4 focus:bg-surface-white focus:border-outline-gray-4 focus:shadow-sm focus:ring-0 focus-visible:ring-2 focus-visible:ring-outline-gray-3",
    outline:
      "border border-outline-gray-2 bg-surface-white placeholder-ink-gray-5 hover:border-outline-gray-3 hover:shadow-sm focus:bg-surface-white focus:border-outline-gray-4 focus:shadow-sm focus:ring-0 focus-visible:ring-2 focus-visible:ring-outline-gray-3",
    disabled: [
