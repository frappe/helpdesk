    ...
    <template #body-content>
      <div class="space-y-4">
        ...
        <div class="space-y-1.5">
          ...
          <div class="relative">
            <TextEditor
              editor-class="!prose-sm max-w-full overflow-auto min-h-[180px] max-h-80 py-1.5 px-2 rounded border border-[--surface-gray-2] bg-surface-gray-3 placeholder-ink-gray-4 hover:border-outline-gray-modals hover:bg-surface-gray-4 hover:shadow-sm focus:bg-surface-white focus:border-outline-gray-3 focus:shadow-sm focus:ring-0 focus-visible:ring-2 focus-visible:ring-outline-gray-3 text-ink-gray-8 transition-colors"
