<template>
  ...
  >
    ...
    <template #content>
      ...
      >
        <div
          class="grid grid-cols-12 items-center gap-3 text-sm text-ink-gray-6 ml-2"
        >
        ...
        >
          <div
            class="grid grid-cols-12 items-center gap-4 cursor-pointer hover:bg-surface-gray-2 rounded"
          >
            <div
              @click="
