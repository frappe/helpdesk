    ...
    >
      ...
      >
        ...
        <Button
          ...
          :loading="setReplyEmailToAgentsSettings.loading"
        />
      </div>
    </div>
    <!-- Body -->
...
const getEmailEventData = createResource({
  ...
  method: "GET",
  params: {
    email_event: "reply_email_to_agent",
  },
  auto: true,
...
const setReplyEmailToAgentsSettings = createResource({
  url: "helpdesk.api.email_event_settings.set_reply_email_to_agents_settings",
  method: "PUT",
  auto: false,
...
function onSubmit() {
  return setReplyEmailToAgentsSettings.submit({
