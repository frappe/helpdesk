<template>
	<div class="h-full">
		<div
			v-if="isLoading"
			class="h-full w-full flex justify-center align-middle"
		>
								...
								>
									<thead>
										<tr class="bg-gray-100 text-base text-gray-500 select-none">
											...
											<th
												class="text-start last-of-type:rounded-tr-md last-of-type:rounded-br-md font-normal hover:text-gray-600 cursor-pointer fill-gray-300"
