...
echo "Get Helpdesk..."
bench get-app --skip-assets helpdesk "${GITHUB_WORKSPACE}"

echo "Generating POT file..."
bench generate-pot-file --app helpdesk

cd ./apps/helpdesk || exit
...
echo "Creating a PR..."
gh pr create --fill --base "${BASE_BRANCH}" --head "${branch_name}" -R frappe/helpdesk