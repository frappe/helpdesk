(() => {
  // ../helpdesk/helpdesk/public/js/utils.js
  window.FileAttachmentHandler = class FileAttachmentHandler {
    ...
    set_listeners() {
      ...
      $(`body`).on("click", `.delete-button`, function() {
        frappe.confirm(`Are you sure you want to delete the file "${$(this).attr("data-name")}"`, () => {
...
//# sourceMappingURL=helpdesk.bundle.6LU2MLNT.js.map
