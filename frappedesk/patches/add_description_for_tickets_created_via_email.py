from frappedesk.frappedesk.doctype.ticket.ticket import set_descritption_from_communication
import frappe

def execute():
    for ticket in frappe.get_all("Ticket", filters={"via_customer_portal": False}, fields=["name"]):
