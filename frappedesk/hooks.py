...
doc_events = {
	...
	"Contact": {
		"on_trash": [
			...
			"helpdesk.helpdesk.doctype.fd_customer.fd_customer.get_contact_count",
		],
		"after_insert": [
			"helpdesk.helpdesk.doctype.fd_customer.fd_customer.get_contact_count"
		],
	...
	"Ticket": {
		"after_insert": "helpdesk.helpdesk.doctype.fd_customer.fd_customer.get_ticket_count",
		"on_trash": "helpdesk.helpdesk.doctype.fd_customer.fd_customer.get_ticket_count",
	},
}
