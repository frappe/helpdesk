...
def validate_agent_count(doc, method):
	...
	if plan == "Starter" and count >= 3:
		frappe.throw(_("Only a maximum of 3 agents are allowed as per your plan"), exc=PaywallReachedError)
	elif plan == "Essential" and count >= 10:
		frappe.throw(_("Only a maximum of 10 agents are allowed as per your plan"), exc=PaywallReachedError)
	elif plan == "Custom":
